...
import com.cgn.iot.benchmark.entity.enums.SensorType;
import com.cgn.iot.benchmark.function.FunctionParam;
import com.cgn.iot.benchmark.function.FunctionXml;
...
public class Config {
  ...
  public int getKAFKA_PARTITION() {
    return KAFKA_PARTITION;
  }

  public void setKAFKA_PARTITION(int KAFKA_PARTITION) {
